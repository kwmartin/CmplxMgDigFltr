...
%   [margin, smin] = disp_margind(sys,ws,as,wp,e_,type)
%   prints stop-band margins, that is the differences between the
%   stopband loss and the interpolated specs at the frequncies specified
%   by the vector w. As should be in dB. The specification frequencies are
